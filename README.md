...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-respin-bspwm/tree/main/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-respin-bspwm/tree/main/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-respin-bspwm/tree/main/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-respin-bspwm](https://github.com/samwhelp/ubuntu-iso-builder-respin-bspwm)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-respin-bspwm.git
```


> change dir to `ubuntu-iso-builder-respin-bspwm`

``` sh
cd ubuntu-iso-builder-respin-bspwm
```
...
> The resulting ISO file will be placed on `ubuntu-iso-builder-remix-bspwm/dist`
